...
export default function FAQ() {
    ...
    const faqs = {
        شراء: [
            ...
            { q: "إيه طرق الدفع المتاحة؟", a: "في الوقت الحالي بنوفر الدفع عن طريق المحافظ الإلكترونية أو عند الاستلام." },
        ...
        البائعين: [
            { q: "إزاي أسجل كبائع في المنصة؟", a: "سهل جدًا، تواصل معانا على الواتساب الموجود في الصفحة الرئيسية." },
